      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-6">
          ...
          <div className="bg-gradient-to-r from-primary-500 via-primary-400 to-primary-500 rounded-xl shadow-2xl p-6 border-2 border-primary-600">
            <h1 className="text-4xl font-bold text-white mb-2">View Event Details</h1>
        ...
        <div className="bg-white rounded-xl shadow-2xl border-2 border-primary-400 p-8">
          <div className="text-center py-12">
            ...
            <h2 className="text-2xl font-bold text-primary-700 mb-4">Event Details Viewer</h2>
            <p className="text-gray-600 mb-6">
              This feature is coming soon. You'll be able to view and search all configured events here.
            </p>
            <button
